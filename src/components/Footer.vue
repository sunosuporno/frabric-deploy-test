<template>
  ...
  <div class="mt-6 font-body flex flex-col md:flex-row md:justify-evenly">
    <div class="flex flex-col items-center xl:items-start">
      ...
      <router-link :to="{ name: 'Work In Progress'}" class="footer-links" target="_blank">Buy Property</router-link>
      <a
        class="footer-links"
...
"
    ...
    <div class="flex flex-col items-center xl:items-start">
      ...
      <router-link class="footer-links" :to="{ name: 'Work In Progress'}" target="_blank">Vote</router-link>
    </div>
  </div>
  <div class="h-px w-4/5 m-auto bg-[#5A50D8] mt-5"></div>
  <div
